...
const MobileLinks = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
         ...
         <Link to="/my-restaurant" className="hover:text-orange-500 font-bold text-xl text-black py-2">Manage-restaurant</Link>
         <Link to="/order-status" className="hover:text-orange-500 font-bold text-xl text-black py-2">My Order</Link>
